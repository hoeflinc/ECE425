...
HD_PWD='/home/millerid/ECE425/Lab08/lab08/lab08.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_fsm.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mips_fsm.tcl
