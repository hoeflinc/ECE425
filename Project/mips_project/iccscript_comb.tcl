...
set_pin_physical_constraints -pin_name {funct[0]} -layers {metal2} -side 4 -offset 10
set_pin_physical_constraints -pin_name {funct[1]} -layers {metal2} -side 4 -offset 30
set_pin_physical_constraints -pin_name {funct[2]} -layers {metal2} -side 4 -offset 50
set_pin_physical_constraints -pin_name {funct[3]} -layers {metal2} -side 4 -offset 70
set_pin_physical_constraints -pin_name {funct[4]} -layers {metal2} -side 4 -offset 90
set_pin_physical_constraints -pin_name {funct[5]} -layers {metal2} -side 4 -offset 110

set_pin_physical_constraints -pin_name {aluop[0]} -layers {metal2} -side 1 -offset 10
set_pin_physical_constraints -pin_name {aluop[1]} -layers {metal2} -side 1 -offset 30

set_pin_physical_constraints -pin_name {alucontrol[0]} -layers {metal2} -side 2 -offset 10
set_pin_physical_constraints -pin_name {alucontrol[1]} -layers {metal2} -side 2 -offset 30
set_pin_physical_constraints -pin_name {alucontrol[2]} -layers {metal2} -side 2 -offset 50
set_pin_physical_constraints -pin_name {alucontrol[3]} -layers {metal2} -side 2 -offset 70
set_pin_physical_constraints -pin_name {alucontrol[4]} -layers {metal2} -side 2 -offset 90
set_pin_physical_constraints -pin_name {alucontrol[5]} -layers {metal2} -side 2 -offset 110
set_pin_physical_constraints -pin_name {alucontrol[6]} -layers {metal2} -side 2 -offset 130
