...
set_pin_physical_constraints -pin_name {op[6]} -layers {metal2} -side 4 -offset 26.7
set_pin_physical_constraints -pin_name {op[5]} -layers {metal2} -side 4 -offset 29.1
set_pin_physical_constraints -pin_name {op[4]} -layers {metal2} -side 4 -offset 38.7
set_pin_physical_constraints -pin_name {op[3]} -layers {metal2} -side 4 -offset 43.5
set_pin_physical_constraints -pin_name {op[2]} -layers {metal2} -side 4 -offset 48.6
set_pin_physical_constraints -pin_name {op[1]} -layers {metal2} -side 4 -offset 96.3
set_pin_physical_constraints -pin_name {op[0]} -layers {metal2} -side 4 -offset 84.3

set_pin_physical_constraints -pin_name {funct[5]} -layers {metal2} -side 2
set_pin_physical_constraints -pin_name {funct[4]} -layers {metal2} -side 2
set_pin_physical_constraints -pin_name {funct[3]} -layers {metal2} -side 2
set_pin_physical_constraints -pin_name {funct[2]} -layers {metal2} -side 2
set_pin_physical_constraints -pin_name {funct[1]} -layers {metal2} -side 2
set_pin_physical_constraints -pin_name {funct[0]} -layers {metal2} -side 2

set_pin_physical_constraints -pin_name {alu_op[1]} -layers {metal2} -side 1
set_pin_physical_constraints -pin_name {alu_op[0]} -layers {metal2} -side 1

###### Adjust density here to alleviate LVS errors after routing at the expense of a larger design
create_floorplan -control_type "aspect_ratio" -core_aspect_ratio "2" -core_utilization "0.4" -row_core_ratio "1" -start_first_row  -left_io2core 24 -bottom_io2core 27 -right_io2core 24 -top_io2core 27
